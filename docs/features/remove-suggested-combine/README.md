...
## UX
- When 2 images are loaded, Brood still supports `Multi view` and the 2-image Quick Actions.
...
- Manual:
  ...
  - Click `Multi view`: confirm 2-image Quick Actions still appear and work.

## Notes
- This does not remove the actual `Combine` Quick Action; it only removes the proactive suggestion UI.
